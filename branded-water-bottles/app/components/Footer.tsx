        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              {/* Social Media Icons */}
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-r hover:from-blue-600 hover:to-cyan-500 transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#services" className="text-gray-400 hover:text-cyan-400 transition-colors">Our Services</a>
              </li>
              <li>
                <a href="#portfolio" className="text-gray-400 hover:text-cyan-400 transition-colors">Portfolio</a>
              </li>
              <li>
                <a href="#contact" className="text-gray-400 hover:text-cyan-400 transition-colors">Contact Us</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Logo Printing</li>
              <li className="text-gray-400">Label Designing</li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-400">info@brandedwater.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400">123 Water Street<br />Business District, NY 10001</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} Branded Water Bottles. All rights reserved.
            </p>
